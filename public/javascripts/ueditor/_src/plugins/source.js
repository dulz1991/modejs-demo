        ...
        if(opt.sourceEditor == "codemirror"){
            me.addListener("ready",function(){
                utils.loadFile(document,{
                    src : opt.codeMirrorJsUrl || opt.UEDITOR_HOME_URL + "../javascripts/ueditor/third-party/codemirror2.15/codemirror.js",
                    tag : "script",
                ...
                utils.loadFile(document,{
                    ...
                    rel : "stylesheet",
                    type : "text/css",
                    href : opt.codeMirrorCssUrl || opt.UEDITOR_HOME_URL + "../javascripts/ueditor/third-party/codemirror2.15/codemirror.css"
                });
